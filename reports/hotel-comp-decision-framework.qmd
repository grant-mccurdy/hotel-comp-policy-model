...
[Executive brief PDF](reports/hotel-comp-decision-framework.pdf) · [Policy selection appendix](reports/policy-selection-technical-appendix.html) · [Open the Decision Desk](https://hotel-comp-decision-desk.grant-mccurdy.workers.dev/)
:::
...
::: {.prototype-link .content-visible when-format="html"}
**Test the prototype.** Change the incident, guest, operating-pressure, and available-gesture inputs to see the recommendation, cost range, alternatives, reasoning, and required confirmations.

[Open the synthetic Decision Desk](https://hotel-comp-decision-desk.grant-mccurdy.workers.dev/)

*Synthetic scenarios only. Do not enter actual guest or reservation information.*
:::

::: {.content-visible when-format="pdf"}
**Test the synthetic prototype:** [Open the Decision Desk](https://hotel-comp-decision-desk.grant-mccurdy.workers.dev/). Use synthetic scenarios only; do not enter actual guest or reservation information.
:::
