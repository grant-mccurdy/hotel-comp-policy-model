...
CLOUDFLARE_RUNTIME_BUNDLE_MODULE_PATH = PROJECT_ROOT / "cloudflare" / "src" / "runtime_bundle.py"
CLOUDFLARE_RUNTIME_SOURCE_DIR = PROJECT_ROOT / "cloudflare" / "src" / "scripts"
CLOUDFLARE_RUNTIME_SOURCE_MANIFEST_PATH = PROJECT_ROOT / "cloudflare" / "src" / "runtime_source_manifest.json"
